(function () {
            ...
            * @category Wallet API
            */
            const AccountsDiscoveryKind = Object.freeze({ Bip44: 0, "0": "Bip44", });
            /**
            * wRPC protocol encoding: `Borsh` or `JSON`
            * @category Transport
            */
            const Encoding = Object.freeze({ Borsh: 0, "0": "Borsh", SerdeJson: 1, "1": "SerdeJson", });
            /**
            ...
            * @category Wallet API
            */
            const NewAddressKind = Object.freeze({ Receive: 0, "0": "Receive", Change: 1, "1": "Change", });
            /**
            *
            ...
            * @category Wallet SDK
            */
            const FeeSource = Object.freeze({ SenderPays: 0, "0": "SenderPays", ReceiverPays: 1, "1": "ReceiverPays", });
            /**
            ...
            * @category Consensus
            */
            const SighashType = Object.freeze({ All: 0, "0": "All", None: 1, "1": "None", Single: 2, "2": "Single", AllAnyOneCanPay: 3, "3": "AllAnyOneCanPay", NoneAnyOneCanPay: 4, "4": "NoneAnyOneCanPay", SingleAnyOneCanPay: 5, "5": "SingleAnyOneCanPay", });
            /**
            *
            ...
            * let rpc = RpcClient({
                ...
                // HTP v69.5: Try local wRPC URL for RpcClient
                var _htpLocalRpcUrl = null; // DISABLED
                *     resolver: new Resolver(), // original resolver (fallback)
            ...
            *
            * ```javascript
            * let rpc = new RpcClient({ url: "ws://127.0.0.1:17210", networkId: "kaspa-testnet-12" });
            *
            * await rpc.connect();
            * ```
            *
            ...
            */
            ...
            function __wbg_get_imports() {
                ...
                imports.wbg.__wbg_new_170a6c447a0bc8cf = function () {
                    return handleError(function (arg0, arg1) {
                        ...
                        // === HTP v69.4: wRPC retry limiter ===
                        var wrpcMaxRetries = 3;
                        var wrpcRetryCount = 0;
                        var wrpcOrigConnect = null;
                ...
                imports.wbg.__wbindgen_closure_wrapper4467 = function (arg0, arg1, arg2) {
                    const ret = makeMutClosure(arg0, arg1, 1203, __wbg_adapter_66);
                    return addHeapObject(ret);
                };
                ...
                imports.wbg.__wbindgen_closure_wrapper4471 = function (arg0, arg1, arg2) {
                    const ret = makeMutClosure(arg0, arg1, 1203, __wbg_adapter_71);
                    return addHeapObject(ret);
                };
                ...
                imports.wbg.__wbindgen_closure_wrapper4475 = function (arg0, arg1, arg2) {
                    const ret = makeMutClosure(arg0, arg1, 1203, __wbg_adapter_76);
                    return addHeapObject(ret);
                };
                imports.wbg.__wbindgen_closure_wrapper12829 = function (arg0, arg1, arg2) {
                    const ret = makeMutClosure(arg0, arg1, 5228, __wbg_adapter_79);
                    return addHeapObject(ret);
                };
                ...
                imports.wbg.__wbindgen_closure_wrapper12833 = function (arg0, arg1, arg2) {
                    const ret = makeMutClosure(arg0, arg1, 5228, __wbg_adapter_84);
                    return addHeapObject(ret);
                };
            ...
            // Auto-initialize (DISABLED -- using external nightly SDK module instead)
            // The inline glue has import mismatches with the nightly WASM binary.
