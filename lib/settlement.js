...
class SettlementEngine {
  ...
  async settleGame(gameId, winnerId, oracleSigs) {
    ...
    // If oracleSigner available, build PSKT
    ...
    // Fallback: mark winner, settlement handled by POST /api/games/:id/settle
    console.log('[Settlement] Game', gameId, 'marked with winner', winnerId, '— use REST settle endpoint');
    return { gameId, winner: winnerId, status: 'pending_server_settle' };
  }
