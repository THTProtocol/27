  ...
  function injectCardCSS() {
    ...
    s.textContent = [
      ...
      '.playing-card.card-back{background:repeating-linear-gradient(',
        ...
        'border-color:rgba(73,232,194,.25);}',
      '.playing-card.card-highlight{box-shadow:0 0 14px rgba(73,232,194,.6);',
        'border-color:rgba(73,232,194,.6);transform:translateY(-4px);}',
      ...
      '.poker-table{background:radial-gradient(ellipse at center,#0d3320 0%,#081a10 100%);',
        'border-radius:16px;border:2px solid rgba(73,232,194,.2);padding:20px;',
        'min-height:400px;display:flex;flex-direction:column;gap:16px;}',
      '.poker-community{text-align:center;padding:16px;',
        'border:1px solid rgba(73,232,194,.1);border-radius:12px;',
      ...
      '.poker-btn-raise{background:rgba(73,232,194,.15);color:#49e8c2;',
        'border:1px solid rgba(73,232,194,.4);}',
      ...
      '.bj-btn-hit{border-color:rgba(73,232,194,.4);color:#49e8c2;}',
      ...
      '.bj-win{background:rgba(73,232,194,.2);color:#49e8c2;}',
