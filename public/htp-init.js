...
(function (window) {
  ...
  function injectBoardCss() {
    ...
    s.id = 'htp-board-css';
    s.textContent = [
      '.htp-board{display:grid;border:2px solid rgba(255,255,255,0.12);border-radius:4px;overflow:hidden;}',
      ...
      '.htp-cell.selected{background:rgba(255,255,255,0.15)!important;}',
      '.htp-cell.legal{background:rgba(255,255,255,0.10)!important;}',
      '.htp-cell.last-move{background:rgba(255,255,255,0.12)!important;}',
